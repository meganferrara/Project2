...
public class Index {
	...
	public PostingsList booleanQuery(String textQuery) { // Highly suggest looking at Improved Tokenizer class tomorrow
		...
		// 2 you will have to return a postings list since the method is of type
		// postingslist
		// 3 use a data structure to save each term
		// 4 use another data structure to save all your postings lists for each term
		// 5 maybe use some kind of boolean to check if you have gone through all the
		// docs
		// 6 maybe keep track whether you need to do an AND or OR merge using an int var
		// or a boolean
		...
		// you will basically check for "!" and remove it from the postings list and
		// then
		...
		// and then you will .not from your plDocs and map your termPL to your numDocs
		// var
